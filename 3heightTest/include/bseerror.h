 ...
 * 
 * Copyright:       Copyright (C) 2001 - 2021 PDF Tools AG, Switzerland
 *                  All rights reserved.
 *
 ***************************************************************************/
...
/** PDF/A messages */
    ...
    PDF_M_PDFA_EVNT_TRREMOVED           = 0x06430207, /* Removed transfer function (device-dependent color effects). */
    PDF_M_PDFA_EVNT_INVC2GGMAP          = 0x06430208, /* Unable to convert non-standard CIDToGIDMap of font '%font%'. */
