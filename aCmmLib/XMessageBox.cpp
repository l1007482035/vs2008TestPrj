...
{
	XIDS_ABORT,            _T("&Abort"), 
	XIDS_CANCEL,           _T("Cancel"),
	XIDS_CONTINUE,         _T("&Continue"),
	XIDS_DONOTASKAGAIN,    _T("Don't ask me again"),
	XIDS_DONOTTELLAGAIN,   _T("Don't tell me again"),
	XIDS_DONOTSHOWAGAIN,   _T("Don't show again"),
	XIDS_HELP,             _T("&Help"),
	XIDS_IGNORE,           _T("&Ignore"),
	XIDS_IGNOREALL,        _T("I&gnore All"),
	XIDS_NO,               _T("&No"),
	XIDS_NOTOALL,          _T("N&o to All"),
	XIDS_OK,               _T("OK"),
	XIDS_REPORT,           _T("Re&port"),
	XIDS_RETRY,            _T("&Retry"),
	XIDS_SKIP,             _T("&Skip"),
	XIDS_SKIPALL,          _T("S&kip All"),
	XIDS_TRYAGAIN,         _T("&Try Again"),
	XIDS_YES,              _T("&Yes"),
	XIDS_YESTOALL,         _T("Y&es to All")
};
...
#else
		int nActualChars = MultiByteToWideChar(CP_GB2312, 0,
