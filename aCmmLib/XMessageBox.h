...
#define XIDS_OK				9001
#define XIDS_CANCEL			9002
#define XIDS_IGNORE			9003
#define XIDS_RETRY			9004
#define XIDS_ABORT			9005
#define XIDS_HELP			9006
#define XIDS_YES				9007
#define XIDS_NO				9008
#define XIDS_CONTINUE		9009
#define XIDS_DONOTASKAGAIN	9010
#define XIDS_DONOTTELLAGAIN	9011
#define XIDS_DONOTSHOWAGAIN	9012
#define XIDS_YESTOALL		9013
#define XIDS_NOTOALL			9014
#define XIDS_TRYAGAIN		9015
#define XIDS_REPORT			9016
#define XIDS_IGNOREALL		9017
#define XIDS_SKIP			9018
#define XIDS_SKIPALL			9019
...
_AA_DLL_EXPORT_ int XMessageBox(HWND hwnd, 
				LPCTSTR lpszMessage,
...
_AA_DLL_EXPORT_ DWORD XMessageBoxGetCheckBox(LPCTSTR lpszCompanyName, LPCTSTR lpszModule, int nLine);

_AA_DLL_EXPORT_ DWORD XMessageBoxGetCheckBox(XMSGBOXPARAMS& xmb);
