...
#define  WM_XLISTCTRL_COMBO_SELECTION					(WM_USER + 0110)
#define  WM_XLISTCTRL_EDIT_END							(WM_USER + 0111)
#define  WM_XLISTCTRL_CHECKBOX_CLICKED					(WM_USER + 0112)
#define  WM_XLISTCTRL_BUTTON_CLICKED					(WM_USER + 0113)
...
class _AA_DLL_EXPORT_ CXListCtrl : public CListCtrl
{
// Construction
public:
	CXListCtrl();
